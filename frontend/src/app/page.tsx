...
export default function HomePage() {
  return <main className="afri-shell min-h-screen">
    <header className="afri-topbar"><Brand /><div className="afri-top-actions"><span className="afri-network"><span />Stellar Testnet</span><ThemeToggle /><button className="afri-icon-action" aria-label="Notifications"><Icon name="bell" size={19} /><i /></button><button className="afri-profile" aria-label="Account menu"><span className="afri-avatar">A</span><span className="afri-chevron">⌄</span></button></div></header>
